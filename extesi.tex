...
Kibana a partire dai dati originali poich\`e Elasticsearch non permette, a
...
documenti con sampling rate = 1 e truncate = 600 ne salva i valori e poi per ogni combinazione
