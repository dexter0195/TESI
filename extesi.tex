...
\begin{figure}[h!]
\begin{center}                          %centra nel mezzo della pagina
  \includegraphics[width=\textwidth]{images/DARPA-uniquesignature-s.png}
  \caption{Numero delle signature univoche al variare del sampling rate}
  \label{}
\end{center}
\end{figure}
...
\begin{figure}[h!]
\begin{center}                          %centra nel mezzo della pagina
  \includegraphics[width=\textwidth]{images/DARPA-uniquesignature-t.png}
  \caption{Numero delle signature univoche al variare del troncamento}
  \label{}
\end{center}
\end{figure}
\fi
...
\bibitem{EXP10} https://docs.oracle.com/cd/E26217\_01/E26796/html/qs-create-vm.html
...
\bibitem{EXP13} https://www.elastic.co/guide/en/elasticsearch/guide/current/inverted-index.html
\bibitem{EXP14} https://redmine.openinfosecfoundation.org/projects/suricata/wiki/Payload\_keywords
...
\bibitem{EXP16} https://www.cybrary.it/2015/05/summarizing-the-five-phases-of-penetration-testing/
\end{thebibliography}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%non numera l'ultima pagina sinistra
\clearpage{\pagestyle{empty}\cleardoublepage}
