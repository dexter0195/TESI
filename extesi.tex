...
(spiegare anche il problema del replay del traffico)
...
in un altro file pcap contenente pacchetti campionati secondo le tecniche sFlow.

Si tratta di un programma scritto in C che utilizza la {\it libpcap } \cite{EXP7},
una libreria scritta in C per analizzare il traffico {\it live} o {\it captured}.
...
Come descritto anche nell'RFC 3176 il seed della funzione {\verb select_random } non
dovrebbe essere alimentato con il tempo poich\`e esso potrebbe non essere abbastanza
